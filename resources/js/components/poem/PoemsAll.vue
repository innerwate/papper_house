<template>
  <div class="row">
    <div class="poems col-12">
      ...
      <categories-menu @update-poems="poemsByCategories" :isUsers='false'></categories-menu>
      <ul v-if="poems" class="poems_list">
        <li v-for="(poem, index) in pageOfItems" :key="index" class="col-4 poem-li">
          <div class="poem_item">
...
export default {
  ...
  methods: {
    ...
    poemsByCategories(categoriesArray) {
      let data = {'categoriesArray' : categoriesArray, 'isUsers' : false}
