 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\User[] $historyPerson
 * @property-read int|null $history_person_count
...
class Image extends Model
{
  ...
  {
    return $this->hasMany(HistoryPerson::class);
  }
}
